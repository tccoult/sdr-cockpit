/**
 * Source selector and visualization controls toolbar
 * Combined toolbar for data source selection and visualization controls
 */
...
export function SourceToolbar({
  ...
  const sharedButtonBase =
    'inline-flex items-center gap-1.5 rounded-sm border px-2.5 py-1 text-xs font-medium transition';
