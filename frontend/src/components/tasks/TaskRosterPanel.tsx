...
export function TaskRosterPanel({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-white text-slate-900 dark:bg-slate-950/30 dark:text-slate-100">
      ...
      <div className="flex gap-2 border-b border-slate-300 px-4 py-3 dark:border-white/10">
            ...
            <button
              ...
              className={[
                ...
                isActive
                  ...
                  : 'border-slate-300 bg-slate-100 text-slate-500 hover:border-slate-400 hover:text-slate-700 dark:border-white/10 dark:bg-slate-900/40 dark:text-slate-300 dark:hover:border-white/20 dark:hover:text-slate-100',
              ].join(' ')}
            >
              {option}
            </button>
